# Heinlein check**mk** 2.5 Plugins

This repository contains [check**mk**](https://checkmk.com/) plugins developed by Heinlein Consulting GmbH and released to the general public.
